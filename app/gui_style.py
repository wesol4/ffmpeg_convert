...
QFrame#Card, QGroupBox {
    background-color: #161f30; border: 1px solid #283248; border-radius: 2px;
}
QGroupBox {
...
QListWidget, QLineEdit, QComboBox, QPlainTextEdit {
    background-color: #121a29; border: 1px solid #283248; border-radius: 2px;
...
QListWidget::item { padding: 4px 2px; border-radius: 2px; }
QListWidget::item:selected { background-color: #1c3a32; color: #d8fff0; }

QPushButton { border: none; border-radius: 2px; padding: 9px 20px; font-weight: 600; }
...
QPushButton#Close {
    background-color: transparent; color: #8a96ab; border: 1px solid #283248;
    font-size: 15px; font-weight: 700; padding: 0;
}
QPushButton#Close:hover   { background-color: #2a3346; color: #f2f5fa; }
QPushButton#Close:pressed { background-color: #1a2336; }

QRadioButton, QCheckBox { spacing: 10px; padding: 3px 0; color: #e7ebf3; }
QRadioButton::indicator, QCheckBox::indicator {
    width: 17px; height: 17px; border-radius: 2px; border: 1.5px solid #3b4863; background: #121a29;
}
...
QProgressBar {
    border: none; border-radius: 2px; background-color: #1c2638; height: 10px;
    text-align: center; color: transparent;
}
QProgressBar::chunk { background-color: #34d399; border-radius: 2px; }

QScrollBar:vertical { background: transparent; width: 10px; margin: 2px; }
QScrollBar::handle:vertical { background: #2c3850; border-radius: 2px; min-height: 24px; }
